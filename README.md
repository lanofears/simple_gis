...
2. [Установка composer (опционально)](#установка-composer-опционально)
3. [Установка файлов проекта](#eстановка-файлов-проекта)
4. [Установка и первоначальная настройка БД](#установка-и-первоначальная-настройка-бд)
5. [Создание рабочей схемы приложения](#создание-рабочей-схемы-приложения)
6. [Загрузка тестовых данных](#загрузка-тестовых-данных)
7. [API: РУКОВОДСТВО](api-руководство)
8. [Рубрики](#рубрики)
9. [Здания](#здания)
